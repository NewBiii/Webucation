                    ...
                    <div style="width: 96%;" align="left">
                        <div class="list-group">
                            ...
                            <div class="list-group-item">
                                ...
                                <c:if test="${notesize>0}">
                                    <a href="/note/mynote?userid=<%=((UserEntity) session.getAttribute("user")).getUserid()%>">进入我的课程</a>
                                </c:if>
                            </div>
                            <%}%>
                            ...
                            <div class="list-group-item">
                                ...
                                <c:if test="${notesize>0}">
                                    <a href="/note/mynote?userid=<%=((UserEntity) session.getAttribute("user")).getUserid()%>">进入笔记收藏</a>
                                </c:if>
                            </div>
                            ...
                            <div class="list-group-item">
                                ...
                                <c:if test="${collcoursesize>0}">
                                    <a href="/note/mynote?userid=<%=((UserEntity) session.getAttribute("user")).getUserid()%>">进入课程收藏</a>
                                </c:if>
                            </div>
